...
| `event_type_distribution` | JSONB | Phân bố theo event_type (normalized): `{"like_post": 0.4, "comment_post": 0.3}` |
...
- **Weight theo event_type**: `message=2.0`, `comment_post=2.0`, `share_post=1.5`, `like_post=1.0`, `view_post=0.1`
...
- **Ngày 1** (10 ngày trước): 5 likes_post, 2 comments_post
  - Base: `1.0 * log(1+5) + 2.0 * log(1+2) = 1.0*1.79 + 2.0*1.10 = 3.99`
  - Decay: `2^(-10/30) = 0.79`
  - Score: `3.99 * 0.79 = 3.15`
  
- **Ngày 2** (5 ngày trước): 3 likes_post, 1 share_post
...
Ví dụ: Nếu user có 100 interactions: 50 likes_post, 20 comments_post, 10 shares_post, 20 views_post
→ `{"like_post": 0.5, "comment_post": 0.2, "share_post": 0.1, "view_post": 0.2}`
...
EVENT_WEIGHTS = {
    ...
    "comment_post": 2.0,      # Tăng nếu comment quan trọng
    "share_post": 1.5,
    "like_post": 1.0,
